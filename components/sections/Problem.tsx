...
const VERDICTS = [
  {
    ...
    aside: "En el grupo, por privado y el jueves en el campo. Siguen faltando dos respuestas.",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    aside: "Nadie avisó. O avisó en un chat que se llenó de mensajes a las once de la noche.",
  },
];
        ...
        <div className={s.pile}>
          ...
          <Reveal variant="scale" delay={250} className={`${s.slot} ${s.a5}`}>
            ...
            <span>
              ...
              <span className={s.callSub}>Delegado · ayer 21:12, 21:14, 21:20, 22:03</span>
            </span>
            </div>
          </Reveal>
